...
C
      ...
      real*8 S,SL,DN,DMIN,FX,F1,LDS,LDT
      real*8 T,H,SF,DF,QF1,QD0,QD1,QA,QB,QC
      real*8 M2,M4,SMALL,VSMALL,LARGE
      real*8 VLARGE,SCBD,LDFAC,T2,DNI,VALUE
...
C
      real*8 D(N),Y(N),Z(N),Q0(NMAX),Q1(NMAX),V(NMAX,NMAX)
